...
import connect.connect; /*Untuk memanggil Koneksi.java dalam Package connect*/
import tampilan.mTable; /*Untk memanggil mTable.java dalam Package Model*/
...
import interface.interfacesewabuku; /*Untuk memanggil InterfaceSewaBuku.java dalam package interface*/

/**
 *
 * 
 */
public class inputsewabuku implements interfacesewabuku {
