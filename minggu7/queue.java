...
/**
 * @author Hilal Alba N./A11.2019.12306
 */
public class Queue {
...
private static void createQueue() {
    ...
    int alpha = 0;
    while(loopX == 0) {
        System.out.print("Masukkan Data (minuman): ");
        ...
        try {
            ...
            System.out.println("Masukan harus berupa minuman!");
            loopX = 0;
        }
    }
...
static void menuProgram() {
    ...
    while(loopX == 0) {
        ...
        try {
            ...
            System.out.println("Masukan harus minuman!");
        }
    }
    System.out.println("");
